...
// Copyright (c) 2013-2014 dzc Developers
...
public:
    enum
    {
        PUBKEY_ADDRESS = 28,  // dzc addresses begin with 'V'
        SCRIPT_ADDRESS = 95, // dzc script addresses begin with 'Y'
...
public:
    enum
    {
        //PUBKEY_ADDRESS = 55,  // DZC: addresses begin with 'P'
        //SCRIPT_ADDRESS = 117, // DZC: addresses begin with 'p'
