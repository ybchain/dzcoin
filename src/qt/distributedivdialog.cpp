...
const char* DistributeDivDialog::columnHeadings[] = {
    "dzc Address", "Shares", "DZC Address", "Dividend"
};
...
bool DistributeDivDialog::ConfirmDistribution()
{
    ...
    {
        QMessageBox::critical(this, "Error", QString("Unable to get DZC balance: %1").arg(error.what()));
        return false;
    }
    QString sQuestion = QString("%1 DZC will be sent to %2 addresses in %3 transaction(s).\nYour current DZC balance is %4.\n\nAre you sure?").arg(
