    ...
    rpcConsole(0)
{
    ...
    issueCurrencyDialog = new IssueCurrencyDialog(this);
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send shares to a dzc address"));
    ...
    aboutAction->setToolTip(tr("Show information about dzc"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for dzc"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/peershares"), tr("Show/Hide &dzc"), this);
    toggleHideAction->setToolTip(tr("Show or hide the dzc window"));
    ...
    exportPeercoinKeysAction = new QAction(QIcon(":/icons/export"), tr("&Export DZC keys"), this);
    exportPeercoinKeysAction->setToolTip(tr("Export the DZC keys associated with the dzc addresses to DZC via RPC"));
    ...
    issueCurrencyAction = new QAction(QIcon(":/icons/peershares"), tr("&Issue"), this);
    issueCurrencyAction->setToolTip(tr("Issue currncy."));

    connect(issueCurrencyAction, SIGNAL(triggered()), this, SLOT(showIssueCurrencyDialog()));
...
void BitcoinGUI::createMenuBar()
{
    ...
    file->addAction(issueCurrencyAction);
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar2->addAction(issueCurrencyAction);
}
...
void BitcoinGUI::setWalletModel(WalletModel *walletModel)
{
    ...
    if(walletModel)
    {
        ...
        issueCurrencyDialog->setModel(walletModel);
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("dzc client"));
    ...
    notificator = new Notificator(tr("dzc-qt"), trayIcon);
}
...
void BitcoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
    ...
    {
        // Click on system tray icon triggers "show/hide dzc"
...
void BitcoinGUI::showIssueCurrencyDialog()
{
    issueCurrencyDialog->show();
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to dzc network", "", count));
}
