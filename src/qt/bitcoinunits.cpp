...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("DZC");
    case mBTC: return QString("m-DZC");
    case uBTC: return QString::fromUtf8("μ-DZC");
...
QString BitcoinUnits::description(int unit)
{
    ...
    {
    case BTC: return QString("DZC");
    case mBTC: return QString("Milli-DZC (1 / 1,000)");
    case uBTC: return QString("Micro-DZC (1 / 1,000,000)");
    default: return QString("???");
    }
}
